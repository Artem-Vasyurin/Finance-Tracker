...
public class ConsoleUtility {
    ...
    private static int getWallet(List<Wallet> wallets) {
    ...
    private static void beginTransaction(Wallet senderWallet, Wallet receiverWallet, int sumTransaction) {
        Random random = new Random();
        Transaction income = new Transaction(random.nextInt(), sumTransaction, TransactionType.INCOME);
        Transaction expense = new Transaction(random.nextInt(), sumTransaction, TransactionType.EXPENSE);
